...
from pycarot.utils.generic import check_if_global_is_not_none


_EXPERIMENT_CLASS = ClassificationExperiment
_CURRENT_EXPERIMENT: ClassificationExperiment | None = None
...
def setup(
    ...
    numeric_imputation: float | str = "mean",
...
@check_if_global_is_not_none(globals(), _CURRENT_EXPERIMENT_DECORATOR_DICT)
def get_allowed_engines(estimator: str) -> str | None:
...
@check_if_global_is_not_none(globals(), _CURRENT_EXPERIMENT_DECORATOR_DICT)
def get_engine(estimator: str) -> str | None:
...
@check_if_global_is_not_none(globals(), _CURRENT_EXPERIMENT_DECORATOR_DICT)
def save_model(model, model_name: str, model_only: bool = False, verbose: bool = True, **kwargs):
    """
...
@check_if_global_is_not_none(globals(), _CURRENT_EXPERIMENT_DECORATOR_DICT)
def get_logs(experiment_name: str | None = None, save: bool = False) -> pd.DataFrame:
    """
...
@check_if_global_is_not_none(globals(), _CURRENT_EXPERIMENT_DECORATOR_DICT)
def get_config(variable: str | None = None):
    """
...
@check_if_global_is_not_none(globals(), _CURRENT_EXPERIMENT_DECORATOR_DICT)
def save_experiment(path_or_file: str | os.PathLike | BinaryIO, **cloudpickle_kwargs) -> None:
    """
    ...
    **cloudpickle_kwargs:
    ...
    return _CURRENT_EXPERIMENT.save_experiment(path_or_file=path_or_file, **cloudpickle_kwargs)
...
@check_if_global_is_not_none(globals(), _CURRENT_EXPERIMENT_DECORATOR_DICT)
def create_app(estimator, app_kwargs: dict | None = None) -> None:
    """
