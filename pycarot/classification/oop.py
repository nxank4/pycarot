...
from pycarot.containers.metrics.classification import get_all_metric_containers
from pycarot.containers.models.classification import (
    ALL_ALLOWED_ENGINES,
...
from pycarot.internal.preprocess.preprocessor import Preprocessor
from pycarot.internal.pycaret_experiment.non_ts_supervised_experiment import (
...
from pycarot.utils.constants import DATAFRAME_LIKE, SEQUENCE_LIKE, TARGET_LIKE
...
class ClassificationExperiment(_NonTSSupervisedExperiment, Preprocessor):
    ...
    def __init__(self) -> None:
        ...
        self._variable_keys = self._variable_keys.union({"fix_imbalance", "is_multiclass"})
    ...
    def setup(
        ...
        index: bool | int | str | SEQUENCE_LIKE = True,
        ...
        pca_components: float | str | None = None,
        feature_selection: bool = False,
        feature_selection_method: str = "classic",
        feature_selection_estimator: str | Any = "lightgbm",
        n_features_to_select: float = 0.2,
    ...
    def optimize_threshold(
        ...
        **shgo_kwargs:
        ...
        if self.is_multiclass:
            raise TypeError("optimize_threshold() cannot be used when target is multi-class.")
        ...
        def objective(x, *args):
            ...
            model_results = (
                ...
                .set_index(["Fold"])
                .loc[[self._get_return_train_score_indices_for_logging(return_train_score=False)]]
            )
    ...
    def dashboard(
        ...
        **kwargs:
        ...
        super().dashboard(estimator, display_format, dashboard_kwargs, run_kwargs, **kwargs)
        ...
        return ExplainerDashboard(explainer, mode=display_format, **dashboard_kwargs).run(
            **run_kwargs
        )
