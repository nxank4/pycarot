...
class ROCAUCMetricContainer(ClassificationMetricContainer):
    def __init__(self, globals_dict: dict) -> None:
        ...
        score_func = pycarot.internal.metrics.BinaryMulticlassScoreFunc(
        ...
        super().__init__(
            ...
            name="AUC",
            score_func=score_func,
            scorer=pycarot.internal.metrics.make_scorer_with_error_score(
                score_func,
...
class RecallMetricContainer(ClassificationMetricContainer):
    def __init__(self, globals_dict: dict) -> None:
        ...
        score_func = pycarot.internal.metrics.BinaryMulticlassScoreFunc(
            pycarot.internal.metrics.EncodedDecodedLabelsScoreFunc(
                metrics.recall_score,
                pycarot.internal.metrics.get_pos_label(globals_dict),
            ),
...
class F1MetricContainer(ClassificationMetricContainer):
    def __init__(self, globals_dict: dict) -> None:
        ...
        score_func = pycarot.internal.metrics.BinaryMulticlassScoreFunc(
            pycarot.internal.metrics.EncodedDecodedLabelsScoreFunc(
                metrics.f1_score, pycarot.internal.metrics.get_pos_label(globals_dict)
            ),
            kwargs_if_binary={"average": "binary"},
        )
        super().__init__(
