...
import pycarot.internal.cuml_wrappers
from pycarot.containers.models.base_model import (
    ModelContainer,
    leftover_parameters_to_categorical_distributions,
)
from pycarot.internal.cuml_wrappers import get_svc_classifier
...
class ClassifierContainer(ModelContainer):
    ...
    def __init__(
        ...
        is_boosting_supported: bool | None = None,
        is_soft_voting_supported: bool | None = None,
...
class MLPClassifierContainer(ClassifierContainer):
    def __init__(self, experiment):
        ...
        from pycarot.internal.tunable import TunableMLPClassifier
...
class RidgeClassifierContainer(ClassifierContainer):
    def __init__(self, experiment):
        ...
        if gpu_imported:
            RidgeClassifier = pycarot.internal.cuml_wrappers.get_ridge_classifier()
        else:
            args = {"random_state": experiment.seed}
...
class RandomForestClassifierContainer(ClassifierContainer):
    def __init__(self, experiment):
        ...
        if gpu_imported:
            RandomForestClassifier = pycarot.internal.cuml_wrappers.get_random_forest_classifier()
...
class VotingClassifierContainer(ClassifierContainer):
    def __init__(self, experiment):
        ...
        from pycarot.internal.tunable import TunableVotingClassifier
