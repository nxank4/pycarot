...
class OrthogonalMatchingPursuitContainer(RegressorContainer):
    def __init__(self, experiment):
        ...
        tune_distributions = {
            "n_nonzero_coefs": IntUniformDistribution(1, len(experiment.X_train.columns))
        }
...
class RandomForestRegressorContainer(RegressorContainer):
    def __init__(self, experiment):
        ...
        if gpu_imported:
            RandomForestRegressor = pycarot.internal.cuml_wrappers.get_random_forest_regressor()
...
class MLPRegressorContainer(RegressorContainer):
    def __init__(self, experiment):
        ...
        from pycarot.internal.tunable import TunableMLPRegressor
...
class VotingRegressorContainer(RegressorContainer):
    def __init__(self, experiment):
        ...
        from pycarot.internal.tunable import TunableVotingRegressor
