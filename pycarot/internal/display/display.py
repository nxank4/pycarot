...
from pycarot.internal.display.display_backend import SilentBackend, detect_backend
from pycarot.internal.display.display_component import MonitorDisplay
from pycarot.internal.display.progress_bar import ProgressBarDisplay
...
class CommonDisplay:
    ...
    def __init__(
        ...
        progress_args: dict[str, Any] | None = None,
        monitor_rows: list[list[str]] | None = None,
    ):
        ...
        self._general_display = detect_backend(backend_id) if self.verbose else SilentBackend()
