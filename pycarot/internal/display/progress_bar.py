...
from pycarot.internal.display.display_backend import (
    DatabricksBackend,
    DisplayBackend,
    JupyterBackend,
)
from pycarot.internal.display.display_component import DisplayComponent
...
class ProgressBarBackend(ABC):
    def __init__(
        ...
        backend: str | DisplayBackend | None = None,
    ) -> None:
        self.value = value
        self.min = min
        self.max = max
...
class ProgressBarDisplay(DisplayComponent):
    def __init__(
        ...
        *,
        ...
        self.pbar_backend_cls: type[CLIProgressBarBackend | JupyterProgressBarBackend] | None = None
