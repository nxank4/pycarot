...
from pycarot.utils.generic import MLUsecase, get_logger
...
def save_model(
    ...
    **kwargs:
    ...
    logger.info(str(model))
    logger.info("save_model() successfully completed......................................")
    gc.collect()
...
def _create_bucket_gcp(project_name: str, bucket_name: str):
    ...
    if bucket_name not in buckets:
        ...
        raise FileExistsError(f"{bucket_name} already exists")
