from pycarot.utils.generic import get_all_object_vars_and_properties, is_fit_var
    ...
    def _clear_estimator_fit_vars(self, fitted_estimator, all: bool = False):
        ...
        try:
            for var in self._fit_vars:
                if all or var not in get_all_object_vars_and_properties(fitted_estimator):
