...
from pycarot.containers.metrics.regression import get_all_metric_containers
from pycarot.containers.models.regression import (
    ALL_ALLOWED_ENGINES,
...
from pycarot.utils.generic import MLUsecase, highlight_setup
...
class RegressionExperiment(_NonTSSupervisedExperiment, Preprocessor):
    ...
    def dashboard(
        ...
        **kwargs:
        ...
        explainer = RegressionExplainer(estimator, X_test_df, self.y_test_transformed, **kwargs)
